                    ...
                    <div class="m-portlet__body">
                        ...
                        <form method="POST" id="form-filter" class="m-form m-form--fit m--margin-bottom-20" role="form">
                            ...
                            <div class="row m--margin-bottom-20">
                                <div class="<?php if(in_array('Brand Edit',session()->get('permission'))){ ?>col-lg-4<?php }else{ ?> col-lg-7 <?php } ?> col-sm-4 m--margin-bottom-10-tablet-and-mobile">
                                    <label>Name:</label>
                                ...
                                <div class="<?php if(in_array('Brand Edit',session()->get('permission'))){ ?>col-lg-4<?php }else{ ?> col-lg-5 <?php } ?> col-sm-4 m--margin-bottom-10-tablet-and-mobile">
                                    <label></label>
                    ...
                    <div class="modal-body">
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-12 pb-15">
                                ...
                                <div class="error error_brand_name text-danger"></div>
                            </div>
                            <div class="col-lg-12 pb-15">
                                <label for="brand_slug" class="form-control-label">
                                    Brand Slug:
                                </label>
                                <input type="text" name="brand_slug" class="form-control" id="brand_slug" readonly>
                                <div class="error error_brand_slug text-danger"></div>
                            </div>
                        </div>
                    </div>
    ...
    var table = $('#brandTable').DataTable({
        ...
        "fnDrawCallback": function () {
            ...
            $(".change_status").on("change", function() {
                ...
                if(status && id){
                    $.ajax({
                        url: "{{url('/change-product-brand-status')}}",
                        type: "POST",
            ...
            $('#add_data').click(function () {
                ...
                $('.modal-title').html('<i class="fas fa-plus-square"></i> <span>Add New Brand</span>');
                $('#save-btn').text('Save');
            });
            ...
            $('.edit_data').click(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#brandForm #brand_id').val(data.brand.id);
                        $('#brandForm #brand_name').val(data.brand.brand_name);
                        $('#brandForm #brand_slug').val(data.brand.brand_slug);
                        $('#brandModal').modal('show');
                        $('.modal-title').html('<i class="fas fa-edit"></i> <span>Edit Brand Data</span>');
                ...
                swal({
                    ...
                    preConfirm: function() {
                        return new Promise(function(resolve) {
                            ...
                            $.ajax({
                            url: '{{ url("product-brand/delete") }}/'+id,
                            type: 'GET',
                            dataType: 'json'
                            })
        ...
        "columnDefs": [
            {
                <?php if( in_array('Brand Edit',session()->get('permission'))){ ?>
