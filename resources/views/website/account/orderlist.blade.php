                                         ...
                                         <tbody>
                                            ...
                                            @foreach($orderlist as $order)
                                             <tr>
                                                ...
                                                {{-- <td>{{$order->delivery_date->format('F d Y') }} </td> --}}
                                                @if($order->delivery_status==1)
                                                    <td><span class="badge2 badge-success">Delivered</span></td>
                                                @else    
                                                    <td><span class="badge2 badge-warning">Pending</span></td>
                                                @endif
                                                <td>{{'QAR '.$order->total_amount}}</td>
                                             <td><a href="{{url('/account/order-view/'.$order->invoice_no)}}"  class="btn btn-info btn-sm"><i class="mdi mdi-eye"></i></a></td>
                                             </tr>
                                             @endforeach

                                            @else 
                                             <tr><td class="text-danger" colspan="5">Not Order Available</td></tr>
                                            @endif
                                         </tbody>
                                    </table>
                                  </div>     
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="id" id="address_id" />  
                              <div class="form-group required">
                                    ...
                                    <input name="first_name" id="f_first_name" class="form-control border-form-control" value="" placeholder="First Name" type="text">
                                    <span class="error error_first_name text-danger"></span>
                                 </div>
                           
                                 <div class="form-group required">
                                    <label class="control-label">Last Name</label>
                                    <input name="last_name"  id="f_last_name" class="form-control border-form-control" value="" placeholder="Last Name" type="text">
                                    <span class="error error_last_name text-danger">The last name field is required.</span>
                                 </div>                                      
                                 <div class="form-group required">
                                    <label class="control-label">Mobile No.</label>
                                    <input name="mobile_no" id="f_mobile_no"  class="form-control border-form-control" type="text" value="">
                    ...
                    $(document).on('click','.edit_address', function() { 
                      ...
                      $.ajax({
                          ...
                          success: function (data) {
                              ...
                              $('.modal-title').html('<i class="fas fa-edit"></i> <span>Edit Address</span>');
