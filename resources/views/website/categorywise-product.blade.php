        ...
        <div class="row column_reverse">
            ...
            <div class="col-md-9">
                ...
                <div class="row no-gutters" id="product_data">
                    @include('website.include.categorywise-product-content')
                </div>
...
function fetch_data(page='', show_perpage='', order_by=''){
    ...
    var url = '{{url("/categorywise-product")}}';
    if(cat_id){
        $.ajax({
            url: url,
            type: "POST",
            data: { cat_id:cat_id, page:page, show_perpage:show_perpage,order_by:order_by,_token:_token },
